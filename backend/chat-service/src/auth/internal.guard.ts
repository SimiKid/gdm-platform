...
/**
 * Protects the Chat Service's internal endpoints (Session Manager → start
 * session, bot identity). Both services share INTERNAL_API_TOKEN and send it
 * as an `x-internal-token` header. Unset = open (local dev).
 */
@Injectable()
